ActiveAdmin.register AdminRequest do
  remove_filter :business_license_attachment, :business_license_blob, :ownership_proof_attachment,
                :ownership_proof_blob, :noc_attachment, :noc_blob, :insurance_attachment, :insurance_blob, :cpics_attachments, :cpics_blobs
  ...
  form decorate: true do |f|
    f.inputs do
      ...
      f.input :pincode
      f.input :business_license, as: :file,
      ...
      f.input :ownership_proof, as: :file,
                                input_html: { accept: 'application/pdf, application/msword, application/vnd.openxmlformats-officedocument.wordprocessingml.document' }
      f.input :noc, as: :file,
                    input_html: { accept: 'application/pdf, application/msword, application/vnd.openxmlformats-officedocument.wordprocessingml.document' }
      f.input :insurance, as: :file,
                          input_html: { accept: 'application/pdf, application/msword, application/vnd.openxmlformats-officedocument.wordprocessingml.document' }
      f.input :status
    end
    f.actions
  ...
  permit_params :contact_email, :contact_no, :admin_emails, :theater_name, :theater_address, :pincode,
                :business_license, :ownership_proof, :noc, :insurance, :status
end
