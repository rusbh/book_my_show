module Showable
  ...
  included do
    ...
    validates :poster,
      attached: true,
      content_type: { in: ["image/jpeg", "image/png"], message: "must be valid image format" },
  ...
  class_methods do
    def languages
      ["hindi", "english", "gujarati", "tamil", "telugu"].index_by(&:itself).freeze
    end

    def genres
      ["action", "adventure", "animation", "biography", "comedy", "crime", "documentary", "drama", "fantasy", "historical", "horror", "mystery", "romance", "science_fiction", "unspecified"]
