...
class TheatersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theater" do
    assert_difference("Theater.count") do
      post theaters_url, params: { theater: { address: @theater.address, city_id: @theater.city_id, name: @theater.name } }
    end
  ...
  test "should update theater" do
    patch theater_url(@theater), params: { theater: { address: @theater.address, city_id: @theater.city_id, name: @theater.name } }
